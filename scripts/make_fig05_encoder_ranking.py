"""Generate fig05_encoder_ranking.{pdf,png} from results/encoder_sweep/*.csv.

Box + strip overlay across 14 graph encoders. Attention-family encoders are
placed left of message-passing encoders for visual grouping.
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_metric_audit(args.out_dir / "_metric_audit.csv", audit, figure_id="fig05")
