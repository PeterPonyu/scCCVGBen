...
def build_summary(datasets: list[dict]) -> dict:
    ...
    # Histogram bins (log10-ish for skewed cell count distribution)
    ...
    # Submission year timeline (parse "Mon DD YYYY" or similar)
    def _year(s):
        s = str(s or "").strip()
