"""Generate fig06_graph_robustness.{pdf,png} from results/graph_sweep/*.csv.

Box + strip overlay across 5 graph-construction methods (kNN-Euc baseline from
encoder_sweep + 4 alternatives from graph_sweep).
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_metric_audit(args.out_dir / "_metric_audit.csv", audit, figure_id="fig06")
