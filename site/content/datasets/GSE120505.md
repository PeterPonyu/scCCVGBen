...
| Field | Value |
|-------|-------|
| **Dataset ID** | `GSE120505` |
| **GSE / GSM accession** | [GSE120505](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE120505) |
| **Modality** | scRNA |
| **Species** | mouse |
| **Tissue** | blood |
| **Cell count** | 14,588 |
| **PubMed** | [PMID:36622281](https://pubmed.ncbi.nlm.nih.gov/36622281/) |
