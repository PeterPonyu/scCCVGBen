...
| Field | Value |
|-------|-------|
| **Dataset ID** | `GSM5769454` |
| **GSE / GSM accession** | [GSM5769454](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM5769454) |
| **Modality** | scATAC |
| **Species** | zebrafish |
| **Tissue** | other |
| **Cell count** | 1,535 |
...
| **Source name (GEO)** | Untreated wild-type utricle |

## GEO title

> Untreated_WT_Utricle_scATACseq
